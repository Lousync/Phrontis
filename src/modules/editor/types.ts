...
/**
 * frontmatter 拆装已上移共享层 `src/lib/frontmatter.ts`（笔记合并 Phase 1，
 * docs/notes-merge-phase1-design.md §1.2）——这里 re-export 保持既有 import 路径不变。
 */
...
/**
 * 拆分/拼装 frontmatter 的实现与文档见 `src/lib/frontmatter.ts`（此处 re-export）。
 */
