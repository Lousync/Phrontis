...
export const SETTINGS = {
  ...
  aiAssistantInlineSuggest: { default: true, type: 'toggle', label: '编辑器内联建议', group: 'AI 助手', desc: '在编辑器里按 Alt+A 让 AI 续写下一句，以灰色幽灵文字呈现；Tab 采纳、Esc 拒绝。仅手动触发，不产生常驻开销', keywords: ['内联', '建议', '续写', '补全', '幽灵', 'ghost', 'inline', 'suggest', 'alt+a', 'assistant'], section: 'aiTools', ui: true, scope: 'global', level: 'normal', affects: 'live', aiTab: 'models' },
