...
import { BlogIcon, ScheduleIcon, KnowledgeIcon, MomentsIcon, ToolboxIcon, SettingsIcon, PluginIcon, EditorIcon, AiTeachingIcon } from './ModuleIcons'
...
export function ActivityBar({ active, onChange, onToggleSidebar, flush }: Props) {
  ...
  // ⚠️ 这里**刻意不**换成 appModules.activityOrder()：那个函数还会追加缺失模块，
  ...
  return (
    ...
    >
      ...
      {/* Bottom: devtools (DEV only) — user 账户模块已并入设置（v3.4.0） */}
